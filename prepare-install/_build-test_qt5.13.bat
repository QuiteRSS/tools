set QTDIR=C:\Qt\5.13.1\msvc2017
set PATH=C:\Qt\5.13.1\msvc2017\bin;C:\Qt\Tools\QtCreator\bin;C:\Program Files (x86)\Microsoft Visual Studio\2017\BuildTools\VC\Tools\MSVC\14.16.27023\bin\HostX86\x86;%PATH%
...
python prepare-install_qt5.13.py --build-test
